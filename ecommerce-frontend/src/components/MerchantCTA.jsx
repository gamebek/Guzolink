...
export default function MerchantCTA() {
  return (
    <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
      <div className="flex flex-col items-start justify-between gap-6 rounded-3xl border border-amber-500/20 bg-gradient-to-br from-amber-500/10 to-transparent p-10 md:flex-row md:items-center">
        <div>
          ...
          <p className="mt-3 max-w-md text-slate-300">
            Set up your storefront and start listing products in minutes —
